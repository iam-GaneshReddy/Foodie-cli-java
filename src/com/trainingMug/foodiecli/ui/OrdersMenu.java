...
public class OrdersMenu extends Menu{
    ...
    private void ordersList() {
        List<Order> ordersList = this.orderController.getOrders();
    ...
    private void newOrderForm() throws DishNotFoundException {
        ...
        try {
            ...
            DishServiceImpl dishService = Factory.getDishServiceImpl();
            ...
            while (addMoreItems == 'Y') {
                ...
                Dish selectedDish = dishService.getByDishId(dishId);
        ...
        } catch (RestaurantNotFoundException | OrderExistException e) {
            System.out.println(e.getMessage());
        }
    }
